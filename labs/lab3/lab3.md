...
│   └── ...
├── static
│   ├── tramnetwork.json ?? (generated by your code)
│   ├── shortest_path.svg ?? (generated by your code)
│   └── tram-url.json ?? (generated by your code)
└── tram
    ├── __init__.py
    ├── admin.py
    ├── apps.py
    ...
    │      ├── home.html !!
	│      ├── images
    │      │   ├── gbg_tramnet.svg ?? (generated by your code)
    │      │   ├── wikipedia_gbg_tramnet.svg !!
    │      │   └── shortest_path.svg ? (link to BASE_DIR/static/)
    │      └── show_route.html !!
    ├── tests.py
    ├── urls.py ?
    ├── utils
